...
def imprimir_agenda(agenda):
    ...
    for i in range(len(agenda) //2):
        ...
        print('%10s%10s %5s-%5s R$%3s %5s-%5s RS%3s' % (nome, origem, ida[0], ida[1], ida[2],
...
solucao_hill_climb = subida_encosta(dominio, funcao_custo)
custo_hill_climb = funcao_custo(solucao_hill_climb)
imprimir_agenda(solucao_hill_climb)
...
#melhor encontrado = 2725 para o genetico
